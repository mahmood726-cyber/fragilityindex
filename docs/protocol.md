        # Fragilityindex: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/fragilityindex.git

        ## Objective

        FragilityIndex calculates fragility metrics for randomised controlled trials and meta-analyses, quantifying how few outcome events would be needed to reverse a statistically significant result.
        ...
        - Code: https://github.com/mahmood726-cyber/fragilityindex.git
